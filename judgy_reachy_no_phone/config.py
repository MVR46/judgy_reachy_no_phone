...
class Config:
    ...
    PERSON_CENTERING_ENABLED: bool = True
    PERSON_CENTERING_INTERVAL: float = 0.20
    PERSON_CENTERING_DEADBAND: float = 0.14
    PERSON_CENTERING_RECENTER_THRESHOLD: float = 0.24
    PERSON_CENTERING_STABLE_FRAMES: int = 4
    PERSON_CENTERING_HOLD_SECONDS: float = 1.25
    PERSON_CENTERING_MOVE_DURATION: float = 0.45
    PERSON_CENTERING_MAX_YAW_DEG: float = 90.0
