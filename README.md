...
├── judgy_reachy_no_phone/       # Reachy Mini Python app package
│   ├── __init__.py
...
│   └── static/              # Local robot-control web UI
├── tools/
│   └── benchmark_tensorrt.py # Optional local performance benchmark
├── index.html               # Hugging Face static demo entry point
├── demo.js                  # Browser-only phone detection demo
├── port_hf.js               # Reachy/WebRTC Hugging Face demo logic
├── style.css                # Hugging Face static demo styling
├── README.md                # This file
├── pyproject.toml           # Package config
├── .gitignore               # Local caches, models, venvs, build outputs
└── .github/
    └── workflows/
